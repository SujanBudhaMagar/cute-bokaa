...
const BookNow = () => {
  ...
  return (
    <div className="min-h-screen bg-primary">
      ...
      {/* Hero Section */}
      <div className="relative w-full h-[650px] bg-primary">
        <Image
          src="/img/book.png"
          alt="Background"
          fill
      ...
      <div
        id="form"
        className="p-6 md:p-10 bg-primary min-h-screen w-full text-white "
      >
        <div className="globalContainer py-10 md:py-20">
            ...
            <div className="bg-[#252525] rounded-xl p-6 w-full md:max-w-4xl flex flex-col justify-around">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mb-4 p-2 rounded bg-primary border border-[#374151] text-[10px] md:text-base"
                />
              </div>
