              ...
              {step === 1 ? (
                <>
                  <input
                    ...
                    required
                    className="w-full mb-4 px-4 py-3 rounded-xl bg-[#151515] text-[#8C9092] border border-[#374151]"
                  />
                  <input
                    type="text"
                    name="name"
                    ...
                    required
                    className="w-full mb-6 px-4 py-3 rounded-xl bg-[#151515] text-[#8C9092] border border-[#374151]"
                  />
                </>
              ) : (
                <>
