  ...
  return (
    <div>
      <div className="w-full space-y-6">
        ...
        <div className="bg-[#252525] border-[1px] border-primary rounded-lg p-6">
          <h2 className="text-[#F3F4F6] text-xl mb-6">Profile Settings</h2>
              ...
              <div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-primary border-[1px] border-[#4B5563] rounded-lg px-3 py-2 text-[#8C9092] focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                </div>
                <div className="my-4">
                  <label
